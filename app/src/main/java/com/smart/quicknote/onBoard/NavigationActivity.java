package com.smart.quicknote.onBoard;
...
import com.smart.quicknote.MainActivity;
import com.smart.quicknote.R;
import com.smart.quicknote.googleAuth.GoogleAuthActivity;
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getItem(0) < 2)
                    ...
                    Intent i = new Intent(NavigationActivity.this, GoogleAuthActivity.class);
                    startActivity(i);
                    finish();
                }
            }
